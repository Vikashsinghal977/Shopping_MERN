...
router.route("/admin/users/:id")
    .get(isAuthenticateUser,authorizRoles("admin"),getSingleUser)
    .put(isAuthenticateUser,authorizRoles("admin"),updateUserRole)
    .delete(isAuthenticateUser,authorizRoles("admin"),DeleteUser)
